...
const careSteps = [
  ...
  },
  {
    ...
    description: "Shield your Charna bag from direct sunlight, heat, and moisture to preserve its beauty.",
    details: [
      ...
      <div className="bg-primary text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white/80 mt-4">
            Preserve the beauty of your Charna leather for generations
          </p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-primary text-white p-8 rounded-lg text-center">
            ...
            <p className="mb-6 max-w-2xl mx-auto">
              ...
              can help maintain your Charna piece to the highest standards.
            </p>
            <Link 
              href="/contact" 
