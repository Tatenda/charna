      ...
      <div className="bg-primary text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-white/80 mt-4">
            Terms of service for Charna luxury leather goods
          </p>
        </div>
      </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border border-secondary-light/20">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600">
                By accessing and using the Charna website and purchasing our products, you accept and agree 
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 mb-4">
                Charna offers luxury leather goods crafted from premium Italian leather. All products are 
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600">
                ...
                Charna and protected by copyright and trademark laws. Unauthorized use is prohibited.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600">
                Charna's liability is limited to the purchase price of the product. We are not liable for 
            ...
            <section className="mb-12">
              ...
              <div className="mt-4 p-4 bg-secondary-light/20 rounded">
                <p className="text-gray-600">
                  ...
                  <strong>Address:</strong> Charna Legal Department<br />
