  ...
  return (
    <div className="relative">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-heading font-bold text-black mb-4 tracking-wider">Bag Methodology</h2>
            <p className="text-xl text-gray-600 mb-8">Know your bag</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Style</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-black mb-4">Functionality</h3>
              <p className="text-gray-700 leading-relaxed">
