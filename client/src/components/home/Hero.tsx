        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl lg:text-5xl font-bold leading-tight" style={{color: '#7A8471'}}>
                Subscribe & Customise
              </h2>
              <p className="text-xl leading-relaxed" style={{color: '#7A8471'}}>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 p-6 bg-white/10 rounded-xl backdrop-blur-sm">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold" style={{color: '#7A8471'}}>Custom Bags</h3>
                    <p style={{color: 'rgba(122, 132, 113, 0.8)'}}>Personalise your perfect bag</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 p-6 bg-white/10 rounded-xl backdrop-blur-sm">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold" style={{color: '#7A8471'}}>Corporate Gifting</h3>
                    <p style={{color: 'rgba(122, 132, 113, 0.8)'}}>Business gifting solutions</p>
                  </div>
                </div>
              </div>
            </div>
